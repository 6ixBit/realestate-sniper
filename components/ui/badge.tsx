  ...
  'inline-flex items-center rounded-full border border-zinc-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-950 focus:ring-offset-2 dark:border-zinc-800 dark:focus:ring-zinc-300',
  {
    variants: {
      variant: {
        ...
        success:
          'border-transparent bg-green-500 text-zinc-50 hover:bg-green-500/80 dark:bg-green-700 dark:text-zinc-50 dark:hover:bg-green-700/80',
        standby:
          'border-transparent bg-yellow-500 text-zinc-900 hover:bg-yellow-500/80 dark:bg-yellow-600 dark:text-zinc-50 dark:hover:bg-yellow-600/80',
